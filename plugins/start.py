...
from info import *
from bot import Bot
#from info import ADMINS, FORCE_MSG, START_MSG, CUSTOM_CAPTION, DISABLE_CHANNEL_BUTTON, #PROTECT_CONTENT
...
async def start(client, message):
    if not await db.is_user_exist(message.from_user.id):
        ...
        await client.send_message(LOG_CHANNEL, log.LOG_TEXT.format(message.from_user.id, message.from_user.mention))
